...
namespace App\Http\Controllers\Reception\Appointment;
...
class AppointmentController extends Controller
{
    ...
    {
        $query = Appointment::with(['clinic', 'doctor', 'patient']);
        ...
        return view("Reception.Appointment.index", compact('appointments', 'status'));
    }
    ...
    public function create()
    {
        ...
        return view('Reception.Appointment.create', compact('clinics', 'doctors', 'patients'));
    }
    ...
    public function edit(Appointment $appointment)
    {
        ...
        return view('Reception.Appointment.edit', compact('appointment', 'clinics', 'doctors', 'patients'));
    }
