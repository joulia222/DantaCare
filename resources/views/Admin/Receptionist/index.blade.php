  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      {{-- end message Section --}}
                ...
                <h5 class="card-title fw-semibold mb-4">Receptionist Table</h5>
                    ...
                    <tbody>
                      @foreach($receptionists as $receptionist)
                                      <tr>
                                          ...
                                          <td>
                                            <img src="{{ asset('image/' . $receptionist->img) }}"
                                        ...
                                        <td>
                                          ...
                                          <td>{{$receptionist->admin->name ?? '-'}}</td>
                                          <td>{{$receptionist->created_at}}</td>
                                          <td>{{$receptionist->updated_at}}</td>
                                          <td>
                                        <div class="d-flex">
                                            <a href="{{ route('admin.receptionist.edit', $receptionist->id) }}" class="btn btn-primary btn-sm me-2">
                                                <i class="ti ti-edit"></i>
                                            </a>    
                                            <form action="{{ route('admin.receptionist.delete', $receptionist->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                                @csrf
                                                @method('DELETE')
