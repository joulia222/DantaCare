                      ...
                      @foreach($nurses as $nurse)
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <td>
                                        <div class="d-flex">
                                            <a href="{{ route('admin.nurse.edit', $nurse->id) }}" class="btn btn-primary btn-sm me-2">
                                                <i class="ti ti-edit"></i>
                                            </a>    
                                            <form action="{{ route('admin.nurse.delete', $nurse->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                                @csrf
                                                @method('DELETE')
