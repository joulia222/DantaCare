...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      {{-- end message Section --}}
                        ...
                        <h5 class="card-title fw-semibold mb-4">Edit Clinic Information</h5>
                        <div class="card-body">
                        ...
                        @endif 
                                ...
                                <div class="col-md-6">
                                    <label for="dentistDepartment" class="form-label">Name of Department</label>
