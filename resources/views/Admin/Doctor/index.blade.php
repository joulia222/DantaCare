  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      {{-- end message Section --}}
                ...
                <h5 class="card-title fw-semibold mb-4">Doctor Table</h5>
                    ...
                    <tbody>
                      @foreach($doctors as $doctor)
                                      <tr>
                                          ...
                                          <td>
                                            <img src="{{ asset('image/' . $doctor->img) }}"
                                        ...
                                        <td>
                                          ...
                                          <td>
                                        <div class="d-flex">
                                            <a href="{{ route('admin.doctor.edit', $doctor->id) }}" class="btn btn-primary btn-sm me-2">
                                                <i class="ti ti-edit"></i>
                                            </a>    
                                            <form action="{{ route('admin.doctor.delete', $doctor->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                                @csrf
                                                @method('DELETE')
