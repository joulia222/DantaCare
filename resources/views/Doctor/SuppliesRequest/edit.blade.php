...
<head>
    ...
    <title>Edit Supplies Request</title>
                    ...
                    <div class="col-lg-12 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body p-4">
                                ...
                                <h5 class="card-title fw-semibold mb-4">Edit Supplies Request</h5>

                                <form action="{{ route('doctor.supplies.request.update', $suppliesRequest) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                            ...
                                            <select class="form-select @error('medical_supplies_id') is-invalid @enderror" name="medical_supplies_id" id="medical_supplies_id">
                                                ...
                                                @foreach($medicalSupplies as $supply)
                                                    <option value="{{ $supply->id }}" 
                                                        ...
                                                        {{ old('medical_supplies_id', $suppliesRequest->medical_supplies_id) == $supply->id ? 'selected' : '' }}>
                                                        {{ $supply->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control @error('quantity') is-invalid @enderror" 
                                                name="quantity" value="{{ old('quantity', $suppliesRequest->quantity) }}" min="1">
                                            @error('quantity')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="datetime-local" class="form-control @error('taken_date') is-invalid @enderror" 
                                                name="taken_date" value="{{ old('taken_date', $suppliesRequest->taken_date) }}">
                                            @error('taken_date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3" id="re_entry_date_container" style="display: none;">
                                            ...
                                            <input type="datetime-local" class="form-control @error('re_entry_date') is-invalid @enderror" 
                                                name="re_entry_date" value="{{ old('re_entry_date', $suppliesRequest->re_entry_date) }}">
                                            @error('re_entry_date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
