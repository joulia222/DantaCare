  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      {{-- end message Section --}}
                ...
                <h5 class="card-title fw-semibold mb-4">Consultation Table</h5>
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                        <thead class="text-dark fs-4">
                            <tr>
                                ...
                                <th class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">Doctor ID</h6>
                                </th>
                                <th class="border-bottom-0">
                        ...
                        <tbody>
                            @foreach($consultations as $consultation)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('doctor.consultation.edit', $consultation) }}" class="btn btn-primary btn-sm me-2">
                                                <i class="ti ti-edit"></i>
                                            </a>    
                                            <form action="{{ route('doctor.consultation.destroy', $consultation) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                                @csrf
                                                @method('DELETE')
